...
public class Groups extends AppCompatActivity {
    Button group1Button,group2Button,group3Button,group4Button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        group1Button = (Button) findViewById(R.id.culturalid);
        group2Button = (Button) findViewById(R.id.technicalid);
        group3Button = (Button) findViewById(R.id.sportid);
       group4Button = (Button) findViewById(R.id.politicalid);
